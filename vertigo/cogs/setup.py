...
class SetupView(discord.ui.View):
    ...
    @discord.ui.button(label="Set Warn Duration", style=discord.ButtonStyle.secondary)
    ...
    @discord.ui.button(label="See Settings", style=discord.ButtonStyle.primary)
...
class AdminSetupView(discord.ui.View):
    ...
    @discord.ui.button(label="Set Flag Duration", style=discord.ButtonStyle.secondary)
    ...
    @discord.ui.button(label="Add Admin Roles", style=discord.ButtonStyle.secondary)
...
class SetupCog(commands.Cog):
    ...
    async def setup_command(self, ctx: commands.Context) -> None:
        ...
        embed = make_embed(action="setup", title="Setup", description="Use the buttons below to configure the server.")
    ...
    async def adminsetup_command(self, ctx: commands.Context) -> None:
        ...
        embed = make_embed(action="adminsetup", title="Admin Setup", description="Admin-only settings.")
        await ctx.send(embed=embed, view=view)
